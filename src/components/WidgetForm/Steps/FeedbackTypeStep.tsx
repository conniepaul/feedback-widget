...
export function FeedbackTypeStep ({ onFeedbackTypeChanged }: FeedbackTypeStepProps) {
    return (
        <> 
            ...
            <span className="text-xl leading-6">What could we do better?</span>
            <CloseButton />
            </header>
            ...
            {Object.entries(feedbackTypes).map(([key, value]) => {
                return (
                    <button 
                        ...
                        onClick = {() => onFeedbackTypeChanged(key as FeedbackType)} // Typescript needs the manual specification of "key"
                        type = "button"
                    >
